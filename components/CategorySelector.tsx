          ...
          {testsForCategory.length > 0 ? (
            <ul className="space-y-4">
              {testsForCategory.map(test => (
                <li key={test.id}>
                  <Link to={`/test/${test.id}/instructions`} className="block border border-slate-200 dark:border-slate-700 p-4 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
